  ...
  return (
    <article className="panel legal-document">
      ...
      <div className="legal-notice">
        ...
        <p>
          Please read this Disclaimer carefully before using DeepMarkets (the
      ...
      <div className="legal-body">
        ...
        <LegalSection number="4" title="Data sources and attribution">
          <p>
            ...
            data obtained from SEC.gov and EDGAR. DeepMarkets does not claim
        ...
        <LegalSection number="6" title="Processing, classifications and errors">
          <p>
            DeepMarkets processes source data using automated and manual rules,
        ...
        <LegalSection number="7" title="No warranties">
          ...
          <p>
            DeepMarkets disclaims warranties of accuracy, completeness,
        ...
        <LegalSection number="8" title="Limitation of liability">
          <p className="legal-emphasis">
            To the fullest extent permitted by applicable law, DeepMarkets and
        ...
        <LegalSection number="9" title="Third-party links and services">
          <p>
            ...
            DeepMarkets does not control and is not responsible for third-party
        ...
        <LegalSection number="10" title="Availability and changes">
          <p>
            ...
            DeepMarkets may revise this Disclaimer by posting an updated version
