...
CREATE INDEX IF NOT EXISTS NORMALIZED_FILING_DATE_IDX
    ON NORMALIZED_FILING (FILING_DATE_ISO DESC, ACCESSION_NUMBER DESC);
...
CREATE INDEX IF NOT EXISTS CANONICAL_FILING_COMPONENT_CANONICAL_IDX
    ON CANONICAL_FILING_COMPONENT (
        CANONICAL_FILING_ID, IS_EFFECTIVE, ACCESSION_NUMBER
    );

CREATE INDEX IF NOT EXISTS CANONICAL_FILING_LATEST_ACCESSION_IDX
    ON CANONICAL_FILING (LATEST_ACCESSION_NUMBER);
...
SELECT
    ...
    I.INFOTABLE_SK,
    D.CUSIP_ID,
    COALESCE(D.CUSIP, UPPER(TRIM(I.CUSIP))) AS CUSIP,
    I.NAMEOFISSUER,
    I.TITLEOFCLASS,
    I.FIGI,
...
LEFT JOIN CUSIP D ON D.CUSIP = UPPER(TRIM(I.CUSIP));
